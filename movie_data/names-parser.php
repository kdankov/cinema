...
if(file_exists($programataCacheFile)){
    ...
    $scraper->save($programataCacheFile);
}
    ...
    foreach ($scraper->find('//ul[class="photo-list"]/li/h2/a/span') as $span){
        ...
        if(empty($movieExists[0])){
            ...
            $insertStmt = $db->prepare('
                INSERT INTO movie_data (bg_title, orig_title, year, imdb_url, imdb_title, bg_title_clean) 
                VALUES(:bg_title, :orig_title, :year, :imdb_url, :imdb_title, :bg_title_clean)
            ');
